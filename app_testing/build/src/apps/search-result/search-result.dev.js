...
const serviceUrlArgs_1 = __importDefault(require("../../core/storybook/serviceUrlArgs"));
const search_result_entry_1 = __importDefault(require("./search-result.entry"));
exports.default = {
    title: "Apps / Search Result",
    component: search_result_entry_1.default,
    argTypes: {
        ...serviceUrlArgs_1.default,
        q: {
            name: "Search string",
            defaultValue: "harry",
            control: { type: "text" }
...
const SearchResult = (args) => react_1.default.createElement(search_result_entry_1.default, { ...args });
