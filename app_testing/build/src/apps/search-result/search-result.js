...
const SearchResult = ({ q, pageSize }) => {
    ...
    return (react_1.default.createElement("div", { className: "search-result-page" },
        react_1.default.createElement(SearchResultHeader_1.default, { hitcount: hitcount, q: q }),
        react_1.default.createElement(FacetLine_1.default, { q: q, filters: filters, filterHandler: filteringHandler }),
        campaignData && campaignData.data && (react_1.default.createElement(Campaign_1.default, { campaignData: campaignData.data })),
        react_1.default.createElement(SearchResultList_1.default, { resultItems: resultItems }),
        PagerComponent,
        (0, general_1.dataIsNotEmpty)(resultItems) && (react_1.default.createElement(FacetBrowserModal_1.default, { q: q, filters: filters, filterHandler: filteringHandler }))));
};
