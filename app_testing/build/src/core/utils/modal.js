...
function Modal({ modalId, closeModalAriaLabelText, children, screenReaderModalDescriptionText, classNames, dataCy = "modal" }) {
    ...
    return (react_1.default.createElement("div", { className: "modal-backdrop", 
        ...
        react_1.default.createElement("div", { className: (0, clsx_1.default)("modal", {
                "modal-show": modalIds.includes(modalId)
            }, classNames), role: "dialog", "aria-labelledby": `modal-${modalId}-description`, "data-cy": dataCy },
            react_1.default.createElement("div", { className: "modal__screen-reader-description", id: `modal-${modalId}-description` }, screenReaderModalDescriptionText),
            react_1.default.createElement("button", { type: "button", 
                ...
                autoFocus: true, className: "btn-ui modal-btn-close", style: {
                ...
                react_1.default.createElement("img", { src: CloseLarge_svg_1.default, alt: "", style: { pointerEvents: "none" } })),
            children)));
}
