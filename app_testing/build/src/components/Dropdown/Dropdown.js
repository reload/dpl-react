...
const Dropdown = ({ arrowIcon, ariaLabel, options, classNames, innerClassNames, handleOnChange, placeholder, cyData, defaultValue }) => {
    ...
    return (react_1.default.createElement("div", { className: classes.root },
        react_1.default.createElement("select", { "data-cy": cyData, className: classes.select, "aria-label": ariaLabel, onChange: checkHandleOnChange }, optionsList.map(({ label, value, disabled }) => (react_1.default.createElement("option", { key: label, value: value, className: classes.option, disabled: disabled, selected: value === defaultValue }, label)))),
        react_1.default.createElement("div", { className: classes.arrowWrapper },
            react_1.default.createElement(DropdownIcon_1.default, { arrowIcon: arrowIcon }))));
};
