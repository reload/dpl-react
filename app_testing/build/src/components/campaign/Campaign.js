...
const Campaign = ({ campaignData }) => {
    ...
    if (campaignData.url) {
        return (React.createElement(link_no_style_1.LinkNoStyle, { url: new URL(campaignData.url), trackClick: trackClick, className: "cursor-pointer" },
            React.createElement(CampaignBody_1.default, { campaignData: campaignData })));
    }
    return React.createElement(CampaignBody_1.default, { campaignData: campaignData });
};
