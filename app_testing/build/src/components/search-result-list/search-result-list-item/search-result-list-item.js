...
const SearchResultListItem = ({ item: { titles: { full: fullTitle }, series, creators, manifestations: { all: manifestations }, workId, workYear }, coverTint, resultNumber }) => {
    ...
    react_1.default.createElement("article", { ref: itemRef, className: "search-result-item arrow arrow__hover--right-small", onClick: handleClick, onKeyUp: (e) => e.key === "Enter" && handleClick },
        react_1.default.createElement("div", { className: "search-result-item__cover" }, showItem && (react_1.default.createElement(search_result_list_item_cover_1.default, { id: manifestationPid, description: String(fullTitle), url: materialFullUrl, tint: coverTint }))),
        react_1.default.createElement("div", { className: "search-result-item__text" },
            react_1.default.createElement("div", { className: "search-result-item__meta" },
                showItem && (react_1.default.createElement(button_favourite_1.default, { id: workId, addToListRequest: addToListRequest })),
                numberInSeries && seriesTitle && (react_1.default.createElement(HorizontalTermLine_1.default, { title: `${t("numberDescriptionText")} ${numberInSeries.number?.[0]}`, subTitle: t("inSeriesText"), linkList: [
                        {
                            url: (0, url_2.constructSearchUrl)(searchUrl, seriesTitle),
                            term: seriesTitle
                        }
                    ] }))),
            react_1.default.createElement("h2", { className: "search-result-item__title text-header-h4", "data-cy": "search-result-item-title" },
                react_1.default.createElement(link_1.Link, { href: materialFullUrl }, fullTitle)),
            author && (react_1.default.createElement("p", { className: "text-small-caption", "data-cy": "search-result-item-author" },
                `${t("byAuthorText")} ${author}`,
                workYear && ` (${workYear.year})`))),
        react_1.default.createElement("div", { className: "search-result-item__availability", "data-cy": "search-result-item-availability" }, showItem && (react_1.default.createElement(availability_labels_1.AvailabiltityLabels, { cursorPointer: true, workId: workId, manifestations: manifestations }))),
