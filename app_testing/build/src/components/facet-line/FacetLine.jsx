...
const FacetLine = ({ q, filters, filterHandler }) => {
    ...
    return (<>
      {!data && <FacetLineFiltersSkeleton_1.default />}
      {data && (<FacetLineFilters_1.default filters={filters} facets={data.search.intelligentFacets} filterHandler={filterHandler}/>)}
      <FacetLineSelected_1.default filters={filters} filterHandler={filterHandler}/>
    </>);
};
