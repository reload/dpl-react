...
const usePager = (hitcount, pageSize, overrideItemsShown) => {
    ...
    const PagerComponent = hitcount ? (react_1.default.createElement(result_pager_1.default, { itemsShown: overrideItemsShown ? overrideItemsShown() : itemsShown, hitcount: hitcount, setPageHandler: pagehandler })) : null;
