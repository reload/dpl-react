...
const LinkNoStyle = ({ url, children, isNewTab = false, className, trackClick, dataCy = "link-no-style" }) => {
    return (react_1.default.createElement(link_1.Link, { href: url, isNewTab: isNewTab, className: `hide-linkstyle ${className || ""}`, trackClick: trackClick, dataCy: dataCy }, children));
};
