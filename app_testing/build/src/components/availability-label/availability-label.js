...
const AvailabilityLabel = ({ manifestText, accessTypes, selected = false, url, faustIds, handleSelectManifestation, cursorPointer = false, dataCy = "availability-label", isbn }) => {
    ...
    const availabilityLabel = (react_1.default.createElement("div", { className: classes.parent, onClick: handleSelectManifestation ?? undefined, onKeyPress: handleSelectManifestation ?? undefined, role: "button", tabIndex: 0, "data-cy": dataCy },
        react_1.default.createElement("div", { className: classes.triangle }),
        react_1.default.createElement("img", { className: classes.check, src: Check_svg_1.default, alt: "check-icon" }),
        manifestText && (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("p", { className: "text-label-semibold ml-24", "data-cy": "availability-label-type" }, manifestText),
            react_1.default.createElement("div", { className: "availability-label--divider ml-4" }))),
        react_1.default.createElement("p", { className: `text-label-normal ${manifestText ? "ml-4" : "ml-24"} mr-8`, "data-cy": "availability-label-status" }, availabilityText)));
    return url && !handleSelectManifestation ? (react_1.default.createElement(link_no_style_1.LinkNoStyle, { url: url }, availabilityLabel)) : (availabilityLabel);
};
