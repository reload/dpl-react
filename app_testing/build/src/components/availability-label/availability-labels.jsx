...
const AvailabiltityLabels = ({ manifestations, workId, selectedManifestation: manifestation, selectManifestationHandler, cursorPointer = false }) => {
    ...
    return (<>
      {manifestations.map((item) => {
            ...
            return (<availability_label_1.AvailabilityLabel key={pid} url={url} cursorPointer={cursorPointer} faustIds={[faustId]} manifestText={materialType} accessTypes={accessTypesCodes} selected={manifestation &&
