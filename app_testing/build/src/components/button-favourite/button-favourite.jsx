...
const ButtonFavourite = ({ id, addToListRequest }) => {
    ...
    return (<button type="button" aria-label={fillState ? t("Remove from favorites") : t("Add to favorites")} onClick={handleClick} className="button-favourite">
      <icon_favourite_1.IconFavourite fill={fillState}/>
    </button>);
};
